...
@Getter
@Setter
public class ViewImminentCapsuleResDto {
    ...
    @Builder
    public ViewImminentCapsuleResDto(String categoryName, String memberNickname, String postTitle, Integer postYear, String postText, String postSong, LocalDateTime postRelease, Boolean postPublic) {
